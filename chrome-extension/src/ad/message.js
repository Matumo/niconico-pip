...
if (executionContext === "background") {
  console.log("Setting up ad skip message listener in background context.");
  chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    try {
      console.debug("Received message:", message);
      // スキップ可能かどうかのチェック要求を中継
  ...
  console.log("Ad message handler initialized in content script context.");
}
