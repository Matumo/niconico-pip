...
import { runTest as run_main_adapter_media_pip_video_element_size_test } from "@test/browser-headless/main/adapter/media/pip-video-element/pip-video-element-size.test.runtime";
import { runTest as run_main_adapter_media_pip_video_element_poster_test } from "@test/browser-headless/main/adapter/media/pip-video-element/pip-video-element-poster.test.runtime";
import { runTest as run_main_adapter_media_pip_video_element_loaded_metadata_test } from "@test/browser-headless/main/adapter/media/pip-video-element/pip-video-element-loaded-metadata.test.runtime";
...
import { runTest as run_main_domain_pip_pip_handlers_test } from "@test/browser-headless/main/domain/pip/pip-handlers.test.runtime";
...
const runtimeTestHandlerMap: Record<string, RuntimeTestHandler> = {
  ...
  [runtimeTestPathMap.main.adapter.media.pipVideoElement.pipVideoElementSizeTest]: () =>
    run_main_adapter_media_pip_video_element_size_test(),
  [runtimeTestPathMap.main.adapter.media.pipVideoElement.pipVideoElementPosterTest]: (request) =>
    run_main_adapter_media_pip_video_element_poster_test(request),
  [runtimeTestPathMap.main.adapter.media.pipVideoElement.pipVideoElementLoadedMetadataTest]: () =>
    run_main_adapter_media_pip_video_element_loaded_metadata_test(),
  ...
  [runtimeTestPathMap.main.domain.pip.pipHandlersTest]: (request) => run_main_domain_pip_pip_handlers_test(request),
